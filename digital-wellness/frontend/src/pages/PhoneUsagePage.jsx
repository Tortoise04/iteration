...
const PhoneUsagePage = () => {
  ...
  return (
    <div>
      <Card title="手机使用情况" extra={<Button type="primary" icon={<PlusOutlined />} onClick={handleAdd}>新增记录</Button>}>
        <Table dataSource={data} columns={columns} rowKey="id" loading={loading} />
      </Card>

      <Modal title={editingRecord ? '编辑记录' : '新增记录'} open={modalVisible} onCancel={() => setModalVisible(false)} footer={null}>
